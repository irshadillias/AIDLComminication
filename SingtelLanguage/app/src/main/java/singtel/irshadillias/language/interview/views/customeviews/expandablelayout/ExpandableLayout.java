package singtel.irshadillias.language.interview.views.customeviews.expandablelayout;
...
public class ExpandableLayout extends FrameLayout {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (orientation == HORIZONTAL) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.
                            VERSION_CODES.JELLY_BEAN_MR1 && getLayoutDirection() ==
    ...
    public interface OnExpansionUpdateListener {
         ...
         *
         * @param expansionFraction Value between 0 (collapsed) and 1 (expanded) representing
         *                          the the expansion progress
